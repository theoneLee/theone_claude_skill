...
4. 简体中文优先 - 优先使用中文术语、表达方式和命名规范
5. 简体中文注释 - 生成的代码注释和文档都应使用简体中文
6. 简体中文思维 - 思考过程和逻辑分析都使用简体中文进行
...
> ❌ ** 反模式 **：全路径类输出，提及类名、文件名时，输出全路径 (例如 “src/main/kotlin/com/mxwis/hub/auth/jwt/signer/JwtSigner.kt”)，最佳实践是直接输出 `JwtSigner.kt` 即可（简洁大于复杂）。
